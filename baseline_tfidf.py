...
def main():
    ...
    # Save report
    report_path = PROJECT_DIR / "baseline_classification_report.txt"
    ...
    dl_metrics_path = PROJECT_DIR / "dl_val_metrics.json"
...
"""
    ...
    # Save comparison
    comparison_path = PROJECT_DIR / "baseline_vs_dl_comparison.txt"
