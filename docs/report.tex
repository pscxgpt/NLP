...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{../outputs/eda_class_distribution.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{../outputs/eda_text_length_distribution.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{../outputs/error_confusion_matrix.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{../outputs/error_top_confusions.png}
